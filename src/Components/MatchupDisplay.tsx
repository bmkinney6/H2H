    ...
    return (
      <div className="matchup-display-container">
        {matchupList.length > 0 && (()=> {
          ...
          const team1 = getTeamByUsername(matchup.team1.username);
          const team2 = getTeamByUsername(matchup.team2.username);
          ...
          return (
            <div key={currentIndex} className="matchup-card">
              <div className="matchup-header">
                <h3 className="team-labelL">{matchup.team1.username} </h3>
                <h3>VS</h3>
                <h3 className="team-labelR">{matchup.team2.username} </h3>
              </div>
              <div className="matchup-header">
                ...
                {positionSlots
                  ...
                  .map((slot) => (
                    <div key={slot} className="position-row">
                      ...
                      <div className="position-slot">{normalizePosition(slot)}</div>
